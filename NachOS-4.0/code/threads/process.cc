...
// sets the process id
void Process::setProcId(int id)
{
    procid = id;
}

// getter for processId
int Process::getProcId()
{
    return procid;
}
...
void Process::Fork(VoidFunctionPtr func, void *args)
{
...
void Process::ThreadFork(int num, VoidFunctionPtr fun)
{
    Thread *t[num + 5];
    for (int i = 1; i <= num; i++)
    {
