...
void ThrdScheduler::ReadyToRun(Thread *thread)
{
...
void ThrdScheduler::Run(Thread *nextThread, bool finishing)
{
...
void ThrdScheduler::CheckToBeDestroyed()
{
